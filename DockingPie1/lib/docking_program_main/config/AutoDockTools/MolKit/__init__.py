...
#from lib.docking_program_main.config.AutoDockTools.MolKit.mmcifParser import MMCIFParser

from .mmcifParser import MMCIFParser
from .mol2Parser import Mol2Parser
from .pdbParser import PdbParser, PdbqParser, PdbqsParser, PdbqtParser, PQRParser, F2DParser
