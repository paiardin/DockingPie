...
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/energyCalculator.py,v 1.5.10.1 2016/02/11 09:24:08 annao Exp $
#
# $Id: energyCalculator.py,v 1.5.10.1 2016/02/11 09:24:08 annao Exp $
#
#
...
class EnergyCalculator:
    ...
    def __init__(self, data, reset=0, lowLim=-999999.0, energy_type='internal'):
        ...
        # energy
        self.energy_matrix = numpy.zeros([len(data), len(data)]) + lowLim
        self.lowLim = lowLim
        self.setRotatable()
        self.setNeighbors()
        self.weedbonds()
    ...
    def dist(self, a, b):
        ...
        """
        d = numpy.array(b.coords) - numpy.array(a.coords)
...
#            return dist
    ...
    def reset_matrix(self):
        self.energy_matrix = numpy.zeros([len(self.data), len(self.data)]) + self.lowLim
        self.weedbonds()
        self.setNeighbors()
