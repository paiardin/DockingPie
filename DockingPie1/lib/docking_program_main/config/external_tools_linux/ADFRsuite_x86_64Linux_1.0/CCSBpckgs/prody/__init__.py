...
try:
    ...
    if rcFolder:
        rcFile = rcFolder + os.sep + '.prodyrc'
except:
    LOGGER.warning("prody.__init__.py: Failed to get mgltools resource folder.\nUsing prody's default .prodyrc file") 

SETTINGS = PackageSettings('prody', rcfile=rcFile, logger=LOGGER)
SETTINGS.load()
