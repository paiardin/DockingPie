...
import AutoDockTools.MolKit as mk
import AutoDockTools.AutoDockTools.MoleculePreparation as mp
# from .AutoDockTools.MolKit import Read
# from .AutoDockTools.MolKit import molecule
# from .AutoDockTools.MolKit import protein
...
if __name__ == '__main__':
    ...
    mols = mk.Read(receptor_filename)
    ...
    RPO = mp.AD4ReceptorPreparation(mol, mode, repairs, charges_to_add,
