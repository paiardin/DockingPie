    ...
    def generate_cavity_func(self):
        ...
        if self.is_empty:
            ...
            try:
                ...
                QtWidgets.QMessageBox.warning(self.docking_programs_child_tabs, "PyMOL Warning", str("PyMOL was not able to load " + self.object_name + "\n\nSomething went wrong in the generation of the Cavity"))
