...
def grid_dimensions(on_value_changed_function):
    ...
    spacing = QtWidgets.QLabel("Spacing:")
    spacing_scroll_vis = QtWidgets.QDoubleSpinBox()
    spacing_scroll_vis.setRange(-1000, 1000)
    spacing_scroll_vis.setSingleStep(0.10)
    spacing_scroll_vis.setDecimals(3)
    spacing_scroll_vis.setValue(1)
