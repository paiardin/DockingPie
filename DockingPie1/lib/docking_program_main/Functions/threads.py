...
"""
Module to display a dialog with a progressbar used when running those functions of DockingPie where a
...
from lib.docking_program_main.Functions.exceptions import DockingPieInterruptedProtocol
...
class Protocol_exec_dialog(QtWidgets.QDialog):
    ...
    def __init__(self, app, docking_pie, function, args,
                 wait_start=0.15,
                 wait_end=0.15,
                 wait_close=0.20,
